...
export const WORDS = {
  he: [
    ...
    // riddle words
    { word: 'אור', hint: 'משהו שמאיר בלי אש' },
    { word: 'מרחב', hint: 'מקום שנמצא בכל מקום אבל אי אפשר לגעת בו' },
    { word: 'הבטחה', hint: 'משהו שאפשר לשבור בלי ידיים' },
    { word: 'רגש', hint: 'משהו שמרגישים אבל לא רואים' },
    { word: 'רעיון', hint: 'משהו שנמצא בראש אבל לא במוח' },
    { word: 'ניסיון', hint: 'משהו שגדל כשנותנים לו זמן' },
    { word: 'סבלנות', hint: 'משהו שאפשר לאבד בלי לזוז' },
    { word: 'לב', hint: 'משהו שאפשר לפתוח בלי מפתח' },
    { word: 'מחשבה', hint: 'משהו שאפשר לשמוע בלי אוזניים' },
    { word: 'תמיכה', hint: 'משהו שאפשר לתת בלי להחזיק' },
  ],
  ar: [
    // short (easy)
